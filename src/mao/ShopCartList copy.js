...
function ShopCartList() {
  ...
  function cartFromLocalStorage(){
    ...
    newCart=[newCart,localStorageCart]
    setMycart(localStorageCart)
  }
  useEffect(()=>{
