        ...
        <>
            <main className="chin-main">
                ...
                <Commoditylist/>
                    ...
                    <CompareProductSort  data={props.data} englishname={englishnameActioncamera}/>
...
export default withRouter (connect(mapStateToProps,mapDispatchToProps)(Actioncamera))